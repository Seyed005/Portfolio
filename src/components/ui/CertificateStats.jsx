      ...
      {cards.map((card, index) => {
        ...
        return (
          <Reveal key={card.label} delay={index * 0.06}>
            <article className="h-full rounded-2xl border border-line bg-elevated p-6 sm:p-7">
              <div className="mb-5 inline-flex size-10 items-center justify-center rounded-full border border-line bg-surface text-ink">
